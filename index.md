...
![](reference/figures/admiralci_hex.png)
...
Please refer to the
[`.github/workflows`](https://pharmaverse.github.io/admiralci/.github/workflows)
...
reusable via the \[`workflow_call`\]\[workflow_call\] GitHub Actions
event.
