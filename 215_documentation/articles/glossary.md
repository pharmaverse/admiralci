# Glossary of GitHub Actions Workflow Keywords

This glossary lists keywords used in the GitHub Actions workflows and
...
- [`concurrency`](https://docs.github.com/en/actions/using-workflows/workflow-syntax-for-github-actions#concurrency):
  Controls the concurrency of workflow runs.
- [`env`](https://docs.github.com/en/actions/using-workflows/workflow-syntax-for-github-actions#env):
  Sets environment variables for jobs or steps.
- [`id`](https://docs.github.com/en/actions/using-workflows/workflow-syntax-for-github-actions#jobsjob_idstepsid):
  Sets an identifier for a step, used for referencing outputs.
- [`if`](https://docs.github.com/en/actions/using-workflows/workflow-syntax-for-github-actions#if):
  Condition to determine if a job or step should run.
- [`inputs`](https://docs.github.com/en/actions/using-workflows/workflow-syntax-for-github-actions#inputs):
  Defines input parameters for workflows or actions.
...
- [`name`](https://docs.github.com/en/actions/using-workflows/workflow-syntax-for-github-actions#name):
  Sets the name of the workflow, job, or step.
...
- [`workflow_call`](https://docs.github.com/en/actions/using-workflows/reusing-workflows#calling-a-reusable-workflow):
  Enables a workflow to be called by other workflows.
- [`workflow_dispatch`](https://docs.github.com/en/actions/using-workflows/events-that-trigger-workflows#workflow_dispatch):
  Allows manual triggering of workflows with optional inputs.

------------------------------------------------------------------------

For more details, see the [GitHub Actions Workflow Syntax
