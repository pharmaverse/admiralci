...
2. **Check URLs in docs**: Uses the
[`lycheeverse/lychee-action`](https://github.com/lycheeverse/lychee-action) to
check URLs in documentation files. It excludes private URLs, GitHub repository
URLs, and additional specified patterns.
