...
The developers are using `renv` framework, to be able to use the same versions between developpers.
...
- Then there is a step to look for current R version on a admiral developer environment, and load the proper R profile (use of the associate `renv.lock` file)
