...
- [Link to the documentation](https://pharmaverse.github.io/admiralci/validation.html)

### Pkgdown

- [Link to workflow code (yml file)](https://github.com/pharmaverse/admiralci/blob/main/.github/workflows/pkgdown.yml)
- [Link to the documentation](https://pharmaverse.github.io/admiralci/pkgdown.html)
...
- [Link to the documentation](https://pharmaverse.github.io/admiralci/push-docker.html)

### Cran Status

- [Link to workflow code (yml file)](https://github.com/pharmaverse/admiralci/blob/main/.github/workflows/cran-status.yml)
- [Link to the documentation](https://pharmaverse.github.io/admiralci/cran-status.html)

### Check R Tags

- [Link to workflow code (yml file)](https://github.com/pharmaverse/admiralci/blob/main/.github/workflows/check-r-tags.yml)
- [Link to the documentation](https://pharmaverse.github.io/admiralci/check-r-tags.html)
