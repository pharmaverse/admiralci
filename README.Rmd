...
The contents of the `.github/workflows/common.yml` file are available in the [`common.yml.inactive`](./.github/workflows/common.yml.inactive) file in this repository.
